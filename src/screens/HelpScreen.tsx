...
import { Alert as WebAlert, openExternalUrl } from "../utils/webPolyfills";
import {
...
const AlertApi = Platform.OS === "web" ? WebAlert : Alert;
...
export default function HelpScreen() {
  ...
  const handleEmail = () => {
    if (isWeb) {
      openExternalUrl(`mailto:${supportContacts.email}`);
      return;
    }
  ...
  const handleSubmitTicket = async () => {
    if (!newTicketSubject || !newTicketDescription) {
      AlertApi.alert("Please fill in all fields");
      return;
    }
    ...
    if (result) {
      ...
      AlertApi.alert("Error", "Failed to submit ticket. Please try again.");
    }
  };
  ...
  return (
    ...
    >
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.contactGrid, isWide && styles.contactGridWide]}>
          <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              AlertApi.alert("Live Chat", "Live chat feature coming soon!")
            }
          >
            <Text style={styles.contactIcon}>💬</Text>
