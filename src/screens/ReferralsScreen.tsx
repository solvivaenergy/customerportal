...
// Use web polyfills for Alert and Share on web
import { Alert as WebAlert, Share as WebShare } from "../utils/webPolyfills";
const Alert = Platform.OS === "web" ? WebAlert : require("react-native").Alert;
const Share = Platform.OS === "web" ? WebShare : require("react-native").Share;
  ...
  return (
    ...
    >
      ...
      <View style={styles.earningsSection}>
        <View style={[styles.earningsCards, isWide && styles.earningsCardsWide]}>
